...
void construct_p2pkh_tx_from_addr(const string priv_key_wif,
...
int main2() {
  ...
  construct_p2pkh_tx_from_addr(priv_key_wif, src_tx_id, src_tx_output_index,
...
int main(int argc, char* argv[]) {
    try {
        ...
        construct_p2pkh_tx_from_addr(priv_key_wif, src_txid, src_vout, target_addr, amount_to_transfer);
